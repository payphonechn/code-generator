package cn.bynow.asuka.utils;


import cn.bynow.asuka.entity.ColumnEntity;
import cn.bynow.asuka.entity.TableEntity;
...
public class AsukaGenerator {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        tableEntity.setTableName("sys_user");
        tableEntity.setComments("user库");
        //表名转换成Java类名
